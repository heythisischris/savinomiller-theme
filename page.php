...
<div id="main-content" >
    <div class="inner">
        <div class="page-content2">
            <img class='about-banner-image left-image mobile-top1' style='margin-top:40px;margin-bottom:40px;float:left;width:60%;' src='<?php echo TEMPLATE_URI ?>/img/studio/4.jpg'>
            <div class='about-banner-image right-image right-block mobile-top2' style='margin-top:40px;margin-bottom:40px;float:right;width:39.5%;background-color:#62B0BB;color:#ffffff;text-align:center;font-size:24px;line-height:50px;display: flex;align-items: center;'><div style="padding:10%;">As sculptors of the spatial environment, our aim is to create meaningful experiences and <b>“carve the very atmosphere and medium”</b> through which we move, breathe, and experience our lives.</div></div>
            ...
            <img class='about-banner-image left-image' style='margin-top:40px;margin-bottom:40px;float:left;width:39.5%;object-position: 75% 0;' src='<?php echo TEMPLATE_URI ?>/img/studio/2.jpg'>
            ...
            <img class='about-banner-image left-image' style='margin-top:40px;margin-bottom:40px;float:left;width:49.75%;' src='<?php echo TEMPLATE_URI ?>/img/studio/6.jpg'>
            <img class='about-banner-image right-image' style='margin-top:40px;margin-bottom:40px;float:right;width:49.75%' src='<?php echo TEMPLATE_URI ?>/img/studio/7.jpg'>
            ...
            <img class='about-banner-image left-image' style='margin-top:40px;margin-bottom:40px;float:left;width:60%;object-position: 75% 0;' src='<?php echo TEMPLATE_URI ?>/img/studio/8.jpg'>
            <img class='about-banner-image right-image' style='margin-top:40px;margin-bottom:40px;float:right;width:39.5%' src='<?php echo TEMPLATE_URI ?>/img/studio/9.jpg'>

            <div class="about-block about-header">SERVICES</div>
            <div class="about-block">LANDSCAPE ARCHITECTURE</div>
            ...
            <div class="about-block">URBAN DESIGN</div>
            ...
            <div class="about-block">ARCHITECTURE</div>
            ...
            <div class="about-block">MASTER PLANNING</div>
            ...
            <img class='about-banner-image' style='margin-top:20px;margin-bottom:0px;' src='<?php echo TEMPLATE_URI ?>/img/studio/5.jpg'>
        </div>
    </div>
</div>    
